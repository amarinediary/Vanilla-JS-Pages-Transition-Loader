...
The loader is using the [brightness() CSS function `brightness(2)`](https://developer.mozilla.org/en-US/docs/Web/CSS/filter-function/brightness()). Setting a lighter theme's color will force you to edit (`g.setAttribute("filter","brightness(2)")`) the brightness to lower value.
